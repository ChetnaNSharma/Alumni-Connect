...
where "url you just copied" (without the quotation marks) is the url to this repository (your fork of this project- important). See the previous steps to obtain the url.
...
Congratulations! Sit and relax, you've made your contribution to Alumni-Connect project. The mentors will now browse through your PR to check for conflicts.
...
# 🏆 After this, project admin and mentors will finally review the changes and will merge your PR if they are found good, otherwise they will suggest the required changes.
